  ...
  },
  {
    ...
    notes: buildTimedNotes(
      [
        ...
        { timeSeconds: 2.813, note: "中", tatann: true },
        { timeSeconds: 3.299, note: "上" },

        { timeSeconds: 4.150, note: "四" },
        { timeSeconds: 4.966, note: "合", tatann: true },
        { timeSeconds: 5.340, note: "老", tatann: true },
        { timeSeconds: 5.748, note: "四" },
        { timeSeconds: 6.667, note: "工" },

        { timeSeconds: 7.564, note: "中" },
        { timeSeconds: 8.387, note: "工" },
        { timeSeconds: 9.183, note: "六" },
        { timeSeconds: 10.112, note: "合" },

        { timeSeconds: 10.962, note: "上" },
        { timeSeconds: 11.784, note: "合" },
        { timeSeconds: 12.607, note: "六" },
        { timeSeconds: 13.509, note: "七" },

        { timeSeconds: 14.412, note: "中" },
        { timeSeconds: 15.235, note: "合" },
        { timeSeconds: 16.111, note: "尺", tatann: true },
        { timeSeconds: 16.509, note: "中", tatann: true },
        { timeSeconds: 16.933, note: "上" },

        { timeSeconds: 17.809, note: "四" },
        { timeSeconds: 18.605, note: "合", tatann: true },
        { timeSeconds: 19.014, note: "老", tatann: true },
        { timeSeconds: 19.481, note: "四" },
        { timeSeconds: 20.384, note: "工" },
